...
const deleteThese = [
  `<meta name="description" content="Coordinape | The Home of GIVE"/>`,
  `<meta property="og:description" content="Coordinape | The Home of GIVE">`,
  `<meta name="twitter:description" content="Coordinape | The Home of GIVE">`,
];
