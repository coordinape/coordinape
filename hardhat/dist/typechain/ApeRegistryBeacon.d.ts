...
export class ApeRegistryBeacon extends BaseContract {
  ...
  functions: {
    ...
    deploymentCount(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  deploymentPref(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;

  deployments(arg0: BigNumberish, overrides?: CallOverrides): Promise<string>;
  ...
  populateTransaction: {
    ...
    deploymentCount(overrides?: CallOverrides): Promise<PopulatedTransaction>;
