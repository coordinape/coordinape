...
insert_circle_integrations?: [{	/** the rows to be inserted */
	objects:ValueTypes["circle_integrations_insert_input"][]},ValueTypes["circle_integrations_mutation_response"]],
insert_circle_integrations_one?: [{	/** the row to be inserted */
	object:ValueTypes["circle_integrations_insert_input"]},ValueTypes["circle_integrations"]],
...
update_profiles?: [{	/** sets the columns of the filtered rows to the given values */
...
update_profiles_by_pk?: [{	/** sets the columns of the filtered rows to the given values */
