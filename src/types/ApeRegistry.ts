...
export interface ApeRegistryInterface extends ethers.utils.Interface {
  functions: {
...
export interface ApeRegistry extends BaseContract {
  ...
  filters: {
    'CallCancelled(bytes32)'(id?: null): CallCancelledEventFilter;
    CallCancelled(id?: null): CallCancelledEventFilter;
