...
export interface ApeDistributorInterface extends ethers.utils.Interface {
  functions: {
...
export type apeVaultFundsTappedEventFilter =
  TypedEventFilter<apeVaultFundsTappedEvent>;

export interface ApeDistributor extends BaseContract {
  ...
  filters: {
    ...
    'apeVaultFundsTapped(address,address,uint256)'(
      ...
      yearnVault?: null,
      amount?: null
    ): apeVaultFundsTappedEventFilter;
    apeVaultFundsTapped(
      apeVault?: string | null,
      yearnVault?: null,
      amount?: null
