      ...
      insert_key_tx_one: [
        {
          object: {
            ...
            buy: data.isBuy,
            share_amount: data.shareAmount.toBigInt(),
            eth_amount: data.ethAmount.toBigInt(),
            protocol_fee_amount: data.protocolEthAmount.toBigInt(),
            subject_fee_amount: data.subjectEthAmount.toBigInt(),
