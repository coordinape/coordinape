...
const OPTIMISM_RPC_URL = `https://opt-mainnet.g.alchemy.com/v2/${REACT_APP_ALCHEMY_OPTIMISM_API_KEY}`;
const ETHEREUM_RPC_URL = `https://eth-mainnet.g.alchemy.com/v2/${REACT_APP_ALCHEMY_ETH_MAINNET_API_KEY}`;
