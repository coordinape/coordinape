...
export const BASE_RPC_URL = `https://base-mainnet.g.alchemy.com/v2/${VITE_FE_ALCHEMY_API_KEY}`; // TODO: Refactor these to be defined in one place across entire app
