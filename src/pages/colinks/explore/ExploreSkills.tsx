...
export const ExploreSkills = () => {
  ...
  const bq = {
    cover_image_url:
      'https://cdn.discordapp.com/attachments/995065349684871229/1192261029380497408/AI-future.jpeg?ex=65b1a91c&is=659f341c&hm=77a79c69f21e5a306f6b72f15c3ff0d8ed14ad619fb039a6705577a68ea96f2f&width=1200',
    prompt: 'What will be the most important skill in the future?',
    css_background_position: undefined,
  };
  return (
    <SingleColumnLayout>
      <Helmet>
