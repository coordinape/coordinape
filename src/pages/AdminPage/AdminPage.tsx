...
import { StaticTable, ApeButton, NoticeBox, ApeAvatar } from 'components';
      ...
      <div className={classes.actionsAndEpochs}>
        <div className={classes.actionBar}>
          <div className={classes.actionBarInner}>
            ...
            <ApeButton size="small" startIcon={<PlusCircleIcon />}>
              Add Contributor
            </ApeButton>
            <ApeButton size="small" startIcon={<PlusCircleIcon />} disabled>
              Add Epoch
            </ApeButton>
          </div>
        </div>
