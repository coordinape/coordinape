    ...
    >
      ...
      <Flex css={{ flexDirection: 'row', gap: '$md' }}>
        <Button
          ...
          color={activeTab === 'giveParty' ? 'selectedSecondary' : 'secondary'}
        >
          Skill Party
        </Button>
        <Button
          ...
          color={
            activeTab === 'surpriseParty' ? 'selectedSecondary' : 'secondary'
          }
        >
          Individual Party
        </Button>
      ...
      >
        ...
        <Text h2>And when we mean business, we mean party!</Text>
      </Flex>
      <Flex
        column
    ...
    <>
      ...
      <Flex column css={{ mt: '$lg', gap: '$md', width: '100%' }}>
        ...
        <TextField
          css={{
            width: '100%',
            outline: errors ? '1px solid $tagAlertText' : '1px solid $border',
            padding: '$sm $md',
            fontSize: '$medium',
            border: 'none',
          }}
