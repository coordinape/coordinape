...
export const createCircleWithDefaults = (circle: IApiCircle): ICircle => {
  ...
  return {
    ...circle,
    tokenName,
    teamSelText: `Select the people you have been working with during this epoch so you can thank them with ${tokenName}`,
    allocText: `Thank your teammates by allocating them ${tokenName}`,
  };
};
