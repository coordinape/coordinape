...
export const AllTypesProps: Record<string, any> = {
  ...
  circle_api_keys_bool_exp: {
    ...
    createdByUser: 'members_bool_exp',
  ...
  circle_api_keys_insert_input: {
    circle: 'circles_obj_rel_insert_input',
    circle_id: 'bigint',
    createdByUser: 'members_obj_rel_insert_input',
  ...
  circle_api_keys_order_by: {
    ...
    createdByUser: 'members_order_by',
    created_at: 'order_by',
    created_by: 'order_by',
    hash: 'order_by',
    name: 'order_by',
  ...
  contributions_insert_input: {
    ...
    id: 'bigint',
    member_id: 'bigint',
    members: 'members_obj_rel_insert_input',
    updated_at: 'timestamptz',
  },
  ...
  gift_private_bool_exp: {
    ...
    recipient: 'members_bool_exp',
    recipient_id: 'bigint_comparison_exp',
    sender: 'members_bool_exp',
  ...
  gift_private_insert_input: {
    gift_id: 'bigint',
    recipient: 'members_obj_rel_insert_input',
    recipient_id: 'bigint',
    sender: 'members_obj_rel_insert_input',
    sender_id: 'bigint',
  },
  ...
  gift_private_order_by: {
    gift_id: 'order_by',
    note: 'order_by',
    recipient: 'members_order_by',
    recipient_id: 'order_by',
    sender: 'members_order_by',
    sender_id: 'order_by',
  },
  ...
  member_private_aggregate_fields: {
    count: {
      columns: 'member_private_select_column',
    },
  },
  member_private_bool_exp: {
    _and: 'member_private_bool_exp',
    _not: 'member_private_bool_exp',
    _or: 'member_private_bool_exp',
    circle: 'circles_bool_exp',
    circle_id: 'bigint_comparison_exp',
  ...
  member_private_obj_rel_insert_input: {
    data: 'member_private_insert_input',
  },
  ...
  member_private_select_column: true,
  members: {
    burns: {
      distinct_on: 'burns_select_column',
      order_by: 'burns_order_by',
  ...
  members_bool_exp: {
    ...
    id: 'bigint_comparison_exp',
    member_private: 'member_private_bool_exp',
    name: 'String_comparison_exp',
  ...
  members_insert_input: {
    ...
    fixed_payment_amount: 'numeric',
    id: 'bigint',
    member_private: 'member_private_obj_rel_insert_input',
  ...
  members_order_by: {
    ...
    give_token_remaining: 'order_by',
    id: 'order_by',
    member_private: 'member_private_order_by',
    name: 'order_by',
    non_giver: 'order_by',
  ...
  nominees_avg_order_by: {
    ...
    id: 'order_by',
    member_id: 'order_by',
    nominated_by_member_id: 'order_by',
  ...
  nominees_bool_exp: {
    ...
    member_id: 'Int_comparison_exp',
    name: 'String_comparison_exp',
    nominated_by_member_id: 'Int_comparison_exp',
    nominated_date: 'date_comparison_exp',
    nominations: 'vouches_bool_exp',
    nominator: 'members_bool_exp',
    updated_at: 'timestamp_comparison_exp',
  ...
  nominees_insert_input: {
    ...
    nominator: 'members_obj_rel_insert_input',
    updated_at: 'timestamp',
  },
  ...
  query_root: {
    ...
    member_private: {
      distinct_on: 'member_private_select_column',
      order_by: 'member_private_order_by',
      where: 'member_private_bool_exp',
    },
  ...
  teammates_insert_input: {
    ...
    id: 'bigint',
    member: 'members_obj_rel_insert_input',
    teammate: 'members_obj_rel_insert_input',
    updated_at: 'timestamp',
  },
  ...
  vouches_insert_input: {
    ...
    updated_at: 'timestamp',
    voucher: 'members_obj_rel_insert_input',
  },
...
export const ReturnTypes: Record<string, any> = {
  ...
  member_private_aggregate: {
    aggregate: 'member_private_aggregate_fields',
    nodes: 'member_private',
  },
  member_private_aggregate_fields: {
    avg: 'member_private_avg_fields',
    count: 'Int',
    max: 'member_private_max_fields',
    min: 'member_private_min_fields',
    stddev: 'member_private_stddev_fields',
    stddev_pop: 'member_private_stddev_pop_fields',
    stddev_samp: 'member_private_stddev_samp_fields',
    sum: 'member_private_sum_fields',
    var_pop: 'member_private_var_pop_fields',
    var_samp: 'member_private_var_samp_fields',
    variance: 'member_private_variance_fields',
  },
  ...
  mutation_root: {
    ...
    delete_members: 'members_mutation_response',
    delete_members_by_pk: 'members',
    ...
    insert_members: 'members_mutation_response',
    insert_members_one: 'members',
    ...
    update_members: 'members_mutation_response',
    update_members_by_pk: 'members',
  ...
  query_root: {
    ...
    member_private: 'member_private',
    member_private_aggregate: 'member_private_aggregate',
    members: 'members',
    members_aggregate: 'members_aggregate',
    members_by_pk: 'members',
    nominees: 'nominees',
    nominees_aggregate: 'nominees_aggregate',
