DROP INDEX IF EXISTS "public"."activities_index_big_question_id";
DROP INDEX IF EXISTS "public"."index_contributions_big_question_id";
...
alter table "public"."activities" add constraint "enforce_foreign_key_exists" CHECK (circle_id IS NOT NULL OR target_profile_id IS NOT NULL OR epoch_id IS NOT NULL OR contribution_id IS NOT NULL OR user_id IS NOT NULL);
