CREATE TABLE
  "public"."poap_holders" (
    ...
    PRIMARY KEY ("id"),
    FOREIGN KEY ("event_id") REFERENCES "public"."poap_events" ("poap_id") ON UPDATE cascade ON DELETE cascade
  );

alter table "public"."poap_holders" add constraint "poap_holders_token_id_key" unique ("token_id");
