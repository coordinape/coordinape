CREATE
OR REPLACE VIEW "public"."colinks_gives_sent_skill_count" AS
SELECT
  colinks_gives.skill,
  colinks_gives.profile_id,
  count(*) AS gives_sent,
  count(*) FILTER (
    WHERE
      (
